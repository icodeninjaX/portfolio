      ...
      <main className="relative mx-auto max-w-2xl px-5 pb-16 pt-12 sm:px-8 sm:pt-16">
        ...
        <div className="mt-6 space-y-6">
          <section className="section-box">
            <h1 className="section-heading text-2xl font-bold text-foreground sm:text-3xl">
              My Journey
            </h1>
              ...
              <div className="space-y-8">
                {journey.map((item, i) => (
                  <div key={i} className="relative pl-9 sm:pl-12">
                    <div className="absolute left-1.5 top-1 h-3 w-3 rounded-full border-2 border-accent bg-card sm:left-2.5 sm:h-3.5 sm:w-3.5" />
